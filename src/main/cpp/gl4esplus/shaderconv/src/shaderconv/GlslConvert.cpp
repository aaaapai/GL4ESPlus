...
// a5: vLanguageTarget != LanguageTarget::LANGUAGE_TARGET_AST
// a7: essl version
// a8:
std::string GlslConvert::Optimize(
	std::string vShaderSource, // a2
	ShaderStage vShaderType, // a3
	ApiTarget vTarget, // a4
	LanguageTarget vLanguageTarget,
	int vGLSLVersion, // a6
	OptimizationStruct vOptimizationStruct // a9
    )
{
	std::string res;
	if (vShaderSource.empty()) return res;
